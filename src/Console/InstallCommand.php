...
namespace Animalinstinct\LaravelAdmin\Console;
...
class InstallCommand extends Command
{
     ...
     * @var string
     */
    protected $signature = 'laravel-admin:install {build : Preinstalled set of packages (basic)}
                            {--composer=global : Absolute path to the Composer binary which should be used to install packages}';

    protected $builds = ['basic'];
     ...
     * @var string
     */
    protected $description = 'Install required set of resources, packages and controllers';
    ...
    {
        if ($this->argument('build') === 'basic') {
            return $this->installBasic();
        }

        $this->components->error('Invalid build. Supported builds are [basic.');
    ...
    protected function interact(InputInterface $input, OutputInterface $output)
    {
        ...
        $input->setArgument('build', $this->components->choice('Which stack would you like to install?', $this->builds));
    }
